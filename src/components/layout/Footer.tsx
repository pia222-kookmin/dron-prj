        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span
                className="font-bold text-xl tracking-widest uppercase text-white"
            ...
            <div className="flex gap-4">
              {FOOTER_CONTENT.social.map((social) => (
                <a
                  key={social.platform}
                  href={social.href}
                  className="w-10 h-10 border border-white/10 hover:border-[#005FAD] hover:text-white rounded flex items-center justify-center text-slate-500 transition-colors"
          ...
          <div>
            ...
            <div className="space-y-2.5 text-sm text-slate-400 font-light">
            ...
            <div className="space-y-2.5">
              {t.links.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="block text-sm text-slate-400 hover:text-white transition-colors font-light"
                >
                  {link.label}
                </a>
              ))}
